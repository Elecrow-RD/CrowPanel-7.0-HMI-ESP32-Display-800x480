...
try:
    ...
    if 0x14 in i2c_devices:
        touch_address = 0x14
    elif 0x5D in i2c_devices:
        touch_address = 0x5D
    else:
        raise OSError("GT911 not found")

    print("GT911 address: 0x{:02X}".format(touch_address))
    tp = gt911.GT911(i2c, width=WIDTH, height=HEIGHT, addr=touch_address)
...
ui_Label1.set_text("--")
ui_Label1.set_width(lv.SIZE.CONTENT)
ui_Label1.set_height(lv.SIZE.CONTENT)
ui_Label1.set_x(-46)
ui_Label1.set_y(-104)
...
ui_Label2.set_text("--")
ui_Label2.set_width(lv.SIZE.CONTENT)
ui_Label2.set_height(lv.SIZE.CONTENT)
ui_Label2.set_x(-47)
ui_Label2.set_y(50)
ui_Label2.set_align(lv.ALIGN.CENTER)
ui_Label2.set_style_text_color(lv.color_hex(0xFDF9F9), lv.PART.MAIN | lv.STATE.DEFAULT)
...
ui_Button1.set_height(84)
ui_Button1.set_x(240)
ui_Button1.set_y(-99)
...
ui_Button2.set_height(84)
ui_Button2.set_x(240)
ui_Button2.set_y(48)
