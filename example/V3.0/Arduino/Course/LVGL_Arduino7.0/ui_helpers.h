...
/*---------------------------------------------------------------
 * Generated UI helper declarations
 * Provide the reusable adapters required by SquareLine event actions.
 *--------------------------------------------------------------*/

#ifndef _BASIC_LVGL_7_5_UI_HELPERS_H
#define _BASIC_LVGL_7_5_UI_HELPERS_H
...
/**
 * @brief Move a text-area cursor in a generated direction.
 * @param target Text area to modify.
 * @param val One of the generated UI_MOVE_CURSOR_* values.
 * @return Nothing.
 * @note Called by generated keyboard actions.
 */
...
/**
 * @brief Increment or decrement a generated spinbox.
 * @param target Spinbox to modify.
 * @param val Sign selecting the step direction.
 * @return Nothing.
 * @note Called by generated spinbox controls.
 */
